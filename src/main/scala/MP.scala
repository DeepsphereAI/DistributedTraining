...
object MP extends App{
   ...
   */
    ...
    /*
     Step #4 :A tokenizer that converts the input string to lowercase and then splits it by white spaces.
    ...
    /*
    Step #5 :HashingTF converts documents to vectors of fixed size.
    */
   ...
   /*
    Step #6 : Select the algorithm
   */
    val vAR_lr = new LogisticRegression()
      .setMaxIter(10)

    /*
      Step #7 : Configure an ML pipeline, which consists of three stages: tokenizer, hashingTF, and lr.
    */
    val vAR_pipeline = new Pipeline()
    .setStages(Array(vAR_tokenizer, vAR_hashingTF, vAR_lr))

    /*
      Step #8 : this grid will have 3 x 2 = 6 parameter settings for CrossValidator to choose from.
    */
    ...
    /*
       Step #9 : Evaluate up to 3 parameter settings in parallel
    */
    ...
    */
    ...
    /*
    Step #12 : Uncomment System.in.read command and comment vAR_spark.stop() to verify at Spark Jobs
      System.in.read
    */
    vAR_spark.stop()
